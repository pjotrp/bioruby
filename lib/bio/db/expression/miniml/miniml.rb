#
# = bio/db/expression/miniml/miniml.rb - MINiML support (as used in NCBI GEO)
#
# Copyright::	Copyright (C) 2008, 2009 Pjotr Prins
# License::	The Ruby License
#
# Bioruby MINiML support. 
#
# MINiML (MIAME Notation in Markup Language, pronounced 'minimal') is a data
# exchange format optimized for microarray gene expression data, as well as
# many other types of high-throughput molecular abundance data. MINiML assumes
# only very basic relations between objects: Platform (e.g., array), Sample
# (e.g., hybridization), and Series (experiment). MINiML captures all
# components of the MIAME checklist, as well as any additional information that
# the submitter wants to provide. MINiML uses XML Schema as syntax.
#
# See http://www.ncbi.nlm.nih.gov/geo/info/MINiML.html
#
# This version reads the GEO family XML file, which can be downloaded through
# FTP, and parses values from the value tables for each sample. 
#
# Notes:
#
  ...
  module Expression
    ...
    module MINiML
      ...
      class Platform 
        ...
        #
        #  m = Bio::Expression::MINiML::GEO_Family.new(fn)
